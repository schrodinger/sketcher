...
Fonts::Fonts() :
    m_main_label_font(QFont(FONT_LIST)),
    m_subscript_font(QFont(FONT_LIST)),
    m_charge_font(QFont(FONT_LIST)),
    m_mapping_font(QFont(FONT_LIST)),
    m_chirality_font(QFont(FONT_LIST)),
    m_sgroup_font(QFont(FONT_LIST)),
    m_query_label_font(QFont(FONT_LIST)),
    m_cursor_hint_font(QFont(FONT_LIST)),
    m_d_amino_acid_font(QFont(FONT_LIST)),
    m_other_amino_acid_font(QFont(FONT_LIST)),
    m_other_nucleic_acid_sugar_and_phosphate_font(QFont(FONT_LIST)),
    m_other_nucleic_acid_base_font(QFont(FONT_LIST)),
    m_monomeric_attachment_point_label_font(QFont(FONT_LIST)),
