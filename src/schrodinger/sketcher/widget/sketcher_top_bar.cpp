...
void SketcherTopBar::onHelpClicked()
{
    auto documentation_url =
        QString("https://www.schrodinger.com/sites/default/files/s3/release/") +
        RELEASE_NAME +
        "/Documentation/html/maestro/maestro_tools_help/2d_sketcher.html";
