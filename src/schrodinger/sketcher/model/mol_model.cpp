    ...
    for (auto atom_tag : atom_tags) {
        ...
        for (const auto* bond : m_mol.atomBonds(atom)) {
            ...
            if (is_attachment_point(other_atom)) {
                ...
                // Only add if not already in the deletion list
