...
// A stable, downloaded artifact can be kept separate from a branch-local
// rebuild.  This lets focused tests continue while Ninja rewrites another
// build directory.  The legacy build-dir form remains the default.
const appDir = process.env.SKETCHER_WASM_APP_DIR || `../../${buildDir}/sketcher_app`;
...
export default defineConfig({
  ...
  webServer: {
    command: `python3 -m http.server 8000 --directory ${appDir}`,
