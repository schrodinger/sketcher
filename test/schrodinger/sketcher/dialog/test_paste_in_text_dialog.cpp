...
BOOST_DATA_TEST_CASE(
    ...
    bdata::make(std::vector<std::tuple<InterfaceTypeType, MoleculeType, bool,
                                       int, bool, bool>>{
        {InterfaceType::ATOMISTIC, MoleculeType::EMPTY, false, 11, true, false},
        {InterfaceType::ATOMISTIC, MoleculeType::ATOMISTIC, false, 11, true,
         false},
        {InterfaceType::ATOMISTIC, MoleculeType::EMPTY, true, 11, true, false},
        {InterfaceType::ATOMISTIC, MoleculeType::ATOMISTIC, true, 11, true,
         false},
        ...
        {InterfaceType::MONOMERIC, MoleculeType::MONOMERIC, true, 5, false,
         true},
        {InterfaceType::ATOMISTIC_OR_MONOMERIC, MoleculeType::EMPTY, false, 15,
         true, true},
        ...
        {InterfaceType::ATOMISTIC_OR_MONOMERIC, MoleculeType::MONOMERIC, false,
         5, false, true},
        {InterfaceType::ATOMISTIC_OR_MONOMERIC, MoleculeType::EMPTY, true, 15,
         true, true},
