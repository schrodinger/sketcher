 ...
 */
class TestStereoBondPopup : public StereoBondPopup
{
  public:
    TestStereoBondPopup()
    {
...
BOOST_AUTO_TEST_CASE(selectionChanged)
{
    ...
    StereoBondPopup popup;
    QSignalSpy spy(&popup, &StereoBondPopup::selectionChanged);
...
bool view_synchronized_to_model(TestStereoBondPopup& wdg)
{
