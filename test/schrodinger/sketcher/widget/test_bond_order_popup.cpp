 ...
 */
class TestBondOrderPopup : public BondOrderPopup
{
  public:
    TestBondOrderPopup()
    {
...
BOOST_AUTO_TEST_CASE(selectionChanged)
{
    ...
    BondOrderPopup popup;
    QSignalSpy spy(&popup, &BondOrderPopup::selectionChanged);
...
bool view_synchronized_to_model(TestBondOrderPopup& wdg)
{
