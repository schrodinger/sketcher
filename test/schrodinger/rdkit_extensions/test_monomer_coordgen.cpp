...
BOOST_DATA_TEST_CASE(
    ...
    bdata::make(std::vector<mol_data_t>{
        ...
        {"RNA1{R(A)P.R(A)P.R(G)P.R(G)P.R(C)P.R(U)P.R(A)P.R(A)P}|RNA2{R(A)P.R(A)"
         ...
         {{0, 0},   {0, -1.5},  {1.5, 0},   {3, 0},   {3, -1.5},  {4.5, 0},
          {6, 0},   {6, -1.5},  {7.5, 0},   {9, 0},   {9, -1.5},  {10.5, 0},
          {12, 0},  {12, -1.5}, {13.5, 0},  {15, 0},  {15, -1.5}, {16.5, 0},
          {18, 0},  {18, -1.5}, {19.5, 0},  {21, 0},  {21, -1.5}, {22.5, 0},
          {45, -6}, {45, -4.5}, {43.5, -6}, {42, -6}, {42, -4.5}, {40.5, -6},
          {39, -6}, {39, -4.5}, {37.5, -6}, {36, -6}, {36, -4.5}, {34.5, -6},
          {33, -6}, {33, -4.5}, {31.5, -6}, {30, -6}, {30, -4.5}, {28.5, -6},
          {27, -6}, {27, -4.5}, {25.5, -6}, {24, -6}, {24, -4.5}, {22.5, -6},
          {24, -3}}},
        ...
        {"RNA1{R(A)P.R(A)P.R(G)P.R(G)P.R(C)P.R(U)P.R(A)P.R(A)P}|RNA2{R(A)P.R(A)"
         ...
         {{0, 0},      {0, -1.5},   {1.5, 0},    {3, 0},      {3, -1.5},
          ...
          {9, -1.5},   {10.5, 0},   {12, 0},     {12, -1.5},  {13.5, 0},
          {15, 0},     {15, -1.5},  {16.5, 0},   {18, 0},     {18, -1.5},
          {19.5, 0},   {21, 0},     {21, -1.5},  {22.5, 0},   {0, -6},
          {0, -4.5},   {-1.5, -6},  {-3, -6},    {-3, -4.5},  {-4.5, -6},
          {-6, -6},    {-6, -4.5},  {-7.5, -6},  {-9, -6},    {-9, -4.5},
          {-10.5, -6}, {-12, -6},   {-12, -4.5}, {-13.5, -6}, {-15, -6},
          {-15, -4.5}, {-16.5, -6}, {-18, -6},   {-18, -4.5}, {-19.5, -6},
          {-21, -6},   {-21, -4.5}, {-22.5, -6}, {-1.5, -3}}},
        ...
        {"RNA1{R(A)P.R(A)P.R(G)P.R(G)P.R(C)P.R(U)P.R(A)P.R(A)P}|RNA2{R(A)P.R(A)"
         ...
         {{0, 0},    {0, -1.5},  {1.5, 0},   {3, 0},   {3, -1.5},  {4.5, 0},
          ...
          {12, 0},   {12, -1.5}, {13.5, 0},  {15, 0},  {15, -1.5}, {16.5, 0},
          {18, 0},   {18, -1.5}, {19.5, 0},  {21, 0},  {21, -1.5}, {22.5, 0},
          {21, -6},  {21, -4.5}, {19.5, -6}, {18, -6}, {18, -4.5}, {16.5, -6},
          {15, -6},  {15, -4.5}, {13.5, -6}, {12, -6}, {12, -4.5}, {10.5, -6},
          {9, -6},   {9, -4.5},  {7.5, -6},  {6, -6},  {6, -4.5},  {4.5, -6},
          {3, -6},   {3, -4.5},  {1.5, -6},  {0, -6},  {0, -4.5},  {-1.5, -6},
          {10.5, -3}}},
    ...
    test_data)
{
    ...
    for (auto monomer : mol->atoms()) {
        ...
        BOOST_CHECK_CLOSE(expected_coords[0], actual_coords[0], 0.01);
        BOOST_CHECK_CLOSE(expected_coords[1], actual_coords[1], 0.01);
    }
}
