...
BOOST_DATA_TEST_CASE(
    ...
    bdata::make(std::vector<mol_data_t>{
        ...
        {"PEPTIDE1{A.C.D.T.A.T.C.V.T.H.R.L.A.G.L.L.S.R.S.G.G.V.V.K.N.N.F.V.P.T."
         "N.V.G.S.K.A.F.[am]}$PEPTIDE1,PEPTIDE1,2:R3-7:R3$$$",
         {{0, 0},
          {1.5, 0},
          {3, 0},
          {4.06066, -1.06066},
        ...
        // Instant turns at the end of short custom-bond intervals still lie
        ...
        // independent turns at positions 2 and 4.
        {"PEPTIDE1{C.A.C.A.C.A.C}$PEPTIDE1,PEPTIDE1,1:R3-5:R3|PEPTIDE1,"
         "PEPTIDE1,3:R3-7:R3$$$",
         {{0, 0},
          {0.433013, -0.75},
          {0, -1.5},
