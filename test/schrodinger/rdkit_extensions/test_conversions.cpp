...
{
    {
        // If there is no residue information, the atomistic -> monomeric conversion
        // will fall back to the SMARTS matching method
        auto smiles = "CC(C)C[C@@H]1NC(=O)[C@H](Cc2c[nH]c3ccccc23)NC(=O)[C@H](CCCCN)NC(=O)[C@H](Cc2ccccc2)NC(=O)[C@@H]2CCCN2C(=O)[C@H]2CCCN2C(=O)[C@H](C(C)O)NC(=O)[C@H](CCC(=O)O)NC(=O)[C@H](Cc2ccccc2)NC(=O)[C@H](CC(N)=O)NC1=O";
    ...
    {
        // If we have a structure that doesn't resemble a sequence of amino acids at all, it 
        // will be placed into a single SMILES monomer
    ...
    {
        // But if we have a single known amino acid, it will be identified as such
